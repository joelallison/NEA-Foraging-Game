...
public class Level {
    ...
    public static Layer[] tilesToGen = new Layer[3];

    public Level() {
        //tree generation
        tilesToGen[0] = new Layer("tree", 1, false, 8, 2, 1.55f, 1.1f, -1, true);
        ...
        //rocks generation
        tilesToGen[1] = new Layer("rock", 2, true, 1, 2, 1.3f, 6f, 2, true);
